...
from api.v1.user import blp as UserBlueprint
from api.v1.pet import blp as PetBlueprint
from api.v1.favorites import blp as FavoriteBlueprint
from flask_mail import Mail, Message
from api.v1.email_utils import configure_mail
...
def create_app(db_url=None):
    ...
    app.config["API_TITLE"] = "Pet REST API"
